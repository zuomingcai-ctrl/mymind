...
| ID | 排期 |
|----|------|
| TE-005, TB-001, TB-005, IN-005 | v1.0+ |
| SC-003, CV-005, CV-006, SH-005 | v1.0+ |
| ZN-007–009, TD-005 | Phase 4 Sprint 4.1–4.2 |
| CM-001–002 | Phase 4 Sprint 4.1 |
| EL-021–023, SK-001–004 | Phase 4 |
| PT-007–009, PP-P04/P06, PP-C02/C07 | Phase 3–4 分批 |
| VW-023, SR-003, FI-007/008, TP-004 | v1.0+ |
| PR-003, TextBundle, PowerPoint | Phase 4 |
| FreeMind/纯文本导入 | Phase 4 |
| §13.3 屏幕阅读器 | v1.0+ |
...
| EL-021 音频备注 | P3，数据模型待补 |
| FI-007 文件加密 | P3，v1.0+ 再补 |
