...
> 当前同步版本：**功能规格 v1.5-draft / 技术设计 v1.5-draft**  
...
| TB-001 分享 | 仅 Tauri/导出链接 | v2.0 协作 |

| CM-003–005 协作评论 | 本地评论命令已有；协作字段 `author`/未读待后端 | v2.0 需后端 |

| VW-010 ZEN 模式 | 仅 UI 状态，无持久化 | 纯视图，v0.3 |

| Phase 2 PWA | 无 Service Worker 章节 | v0.2+ 再补 |

| EL-021 音频备注 | 无数据模型 | P3，v1.0+ 再补 |

| FI-007 文件加密 | 导入明确排除加密文件 | P3，v1.0+ 再补 |
